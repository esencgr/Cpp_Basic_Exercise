...
int main()
{
    ...
    srand(time(NULL));
    int skor=0; // sonucu belirlemek i�in bir degisken atiyoruz
    int a[n];
    int b[n]; //zar degerlerinin tutulmasi i�in hafiza
    for (int i = 0; i < n; i++) {

        int z1 = rand()%6+1; //birincinin zarlari
        int z2 = rand()%6+1; //ikincinin zarlari

        a[i]= z1; //her atanan degeri hafizada tutabilmek i�in alan
        b[i]= z2;
